...
if __name__ == '__main__':
    ...
    ft = Bintang("myft")
    filepath = r"C:\Users\60145210\Documents\AFMO Data\ems_repo\HealthShare SPS.xlsx"
    ...
    colmap = copyconf.ColMapConf("ARTG","ARTG")
    c.colmap_list.append(colmap)
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Manufacturers REF CAT","ManufacturersRefCat")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("DI GTIN","DiGtin")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Product Number","ProductNumber")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Item Number","ItemNumber")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Part Number","PartNumber")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Model name exact","ModelNameExact")
    c.colmap_list.append(colmap)
