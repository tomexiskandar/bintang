...
if __name__ == '__main__':
    ...
    ft = Bintang("myft")
    filepath = r"C:\Users\60145210\Documents\AFMO Data\ems_repo\Hunter New England LHD.xlsx"
    ...
    # for idx, row in ft.iterrows("Original Asset List"):
    #     print(idx, row)  
    #     quit()
    ...
    colmap = copyconf.ColMapConf("BME","BmeNumber")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Serial","SerialNumber")
    c.colmap_list.append(colmap)
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Brand","Brand")
    c.colmap_list.append(colmap)
    ...
    colmap = copyconf.ColMapConf("Service Agent","ServiceAgent")
    c.colmap_list.append(colmap)

    colmap = copyconf.ColMapConf("Software Version","SoftwareVersion")
    c.colmap_list.append(colmap)
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Sub Unit","SubUnit")
    c.colmap_list.append(colmap)
