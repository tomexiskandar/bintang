...
if __name__ == '__main__':
    ...
    ft = Bintang("myft")
    filepath = r"C:\Users\60145210\Documents\AFMO Data\ems_repo\MNCLHD.xlsx"
    ...
    # for idx, row in ft.iterrows("Sheet1"):
        ...
        # if '\n' in row["BMENO"]:
        #     ft["Sheet1"][idx,'BMENO'] = row["BMENO"].replace('\n',' ')
        #     print(row)
    #         quit()
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("MANUFACT","ManufacturerName")
    c.colmap_list.append(colmap)
    ...
    colmap = copyconf.ColMapConf("SER_AGENT","ServiceAgent")
    c.colmap_list.append(colmap)
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("SER_DATE","StartUpDate")
    c.colmap_list.append(colmap)
