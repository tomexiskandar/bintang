...
if __name__ == '__main__':
    ...
    ft = Bintang("myft")
    filepath = r"C:\Users\60145210\Documents\AFMO Data\ems_repo\NBMLHD.xlsx"
    ...
    colmap = copyconf.ColMapConf("EquipTitle","Name")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("ManufacturerName","ManufacturerName")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("GenericName","AlternativeName")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Serial","SerialNumber")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("ModelNum","ModelNumber")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Location","LocationName")
    c.colmap_list.append(colmap)
