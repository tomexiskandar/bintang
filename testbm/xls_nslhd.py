...
if __name__ == '__main__':
    ...
    bt = Bintang("mybt")
    filepath = r"C:\Users\60145210\Documents\AFMO Data\ems_repo\NSLHD North Sydney.xlsx"
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Model No","ModelNumber")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Model Name","ModelName")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Descriptor","Name")
    c.colmap_list.append(colmap)
    # colmap = copyconf.ColMapConf("Model Name2","ModelNameExact")
    # c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Hospital","Hospital")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Replacement Cost","Price")
    c.colmap_list.append(colmap)
