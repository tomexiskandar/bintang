...
if __name__ == '__main__':
    ...
    ft = Bintang("myft")
    filepath = r"C:\Users\60145210\Documents\AFMO Data\ems_repo\SLHD Sydney.xlsx"
    ...
    colmap = copyconf.ColMapConf("Asset Description","Name")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Asset Category Description","SpecClass")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Purchase Value","Price")
    c.colmap_list.append(colmap)
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Site Description","Hospital")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Install Date","StartUpDate")
    c.colmap_list.append(colmap)
