...
if __name__ == '__main__':
    ...
    ft = Bintang("myft")
    filepath = r"C:\Users\60145210\Documents\AFMO Data\ems_repo\SVHNDS St Vincents Hospital Network Sydney.xlsx"
    ...
    colmap = copyconf.ColMapConf("BMI Number","BmeNumber")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("ECRI Description","Name")
    c.colmap_list.append(colmap)
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Company Name","Hospital")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Acquisition Date","DeliveryDate")
    c.colmap_list.append(colmap)
