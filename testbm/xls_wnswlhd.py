...
if __name__ == '__main__':
    ...
    ft = Bintang("myft")
    filepath = r"C:\Users\60145210\Documents\AFMO Data\ems_repo\WNSWLHD Western NSW.xlsx"
    ...
    colmap = copyconf.ColMapConf("Asset Name","Name")
    c.colmap_list.append(colmap)
    ...
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("Spec Class (GMDN)","SpecClass")
    c.colmap_list.append(colmap)
    colmap = copyconf.ColMapConf("In Service Date","StartUpDate")
    c.colmap_list.append(colmap)
